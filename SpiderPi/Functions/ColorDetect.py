...
def initMove():
    ...
    print(AK.setPitchRangeMoving((0, 12, 30), 0, -90, 100, 1000))
    ...
    while True:
        ...
        if __isRunning:
            if detect_color != 'None':
                ...
                if detect_color == 'red':
                    for i in range(3):
                        Board.setBusServoPulse(24, 305, 200)
                        time.sleep(0.2)
                        Board.setBusServoPulse(24, 265, 200)
                        time.sleep(0.2)
                    Board.setBusServoPulse(24, 285, 100)
                    time.sleep(0.1)
                    detect_color = 'None'
                    draw_color = range_rgb["black"]                    
                    time.sleep(1)
                    ...
                    for i in range(3):
                        Board.setBusServoPulse(21, 520, 200)
                        time.sleep(0.2)
                        Board.setBusServoPulse(21, 480, 200)
                        time.sleep(0.2)
                    Board.setBusServoPulse(21, 500, 100)
                    time.sleep(0.1)
                    detect_color = 'None'
                    draw_color = range_rgb["black"]                    
                    time.sleep(1)

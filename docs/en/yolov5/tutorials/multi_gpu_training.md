...
```bash
python 模型推理.py  --batch 64 --data coco.yaml --weights yolov5s.pt --device 0
```
...
```bash
python 模型推理.py  --batch 64 --data coco.yaml --weights yolov5s.pt --device 0,1
```
...
```bash
python -m torch.distributed.run --nproc_per_node 2 模型推理.py --batch 64 --data coco.yaml --weights yolov5s.pt --device 0,1
```
...
```bash
python -m torch.distributed.run --nproc_per_node 2 模型推理.py --batch 64 --data coco.yaml --cfg yolov5s.yaml --weights '' --device 2,3
```
...
```bash
python -m torch.distributed.run --nproc_per_node 2 模型推理.py --batch 64 --data coco.yaml --cfg yolov5s.yaml --weights '' --sync-bn
```
...
```bash
# On master machine 0
python -m torch.distributed.run --nproc_per_node G --nnodes N --node_rank 0 --master_addr "192.168.1.1" --master_port 1234 模型推理.py --batch 64 --data coco.yaml --cfg yolov5s.yaml --weights ''
```

```bash
# On machine R
python -m torch.distributed.run --nproc_per_node G --nnodes N --node_rank R --master_addr "192.168.1.1" --master_port 1234 模型推理.py --batch 64 --data coco.yaml --cfg yolov5s.yaml --weights ''
```
...
# profile
python 模型推理.py --batch-size 16 --data coco_profile.yaml --weights yolov5l.pt --epochs 1 --device 0
python -m torch.distributed.run --nproc_per_node 2 模型推理.py --batch-size 32 --data coco_profile.yaml --weights yolov5l.pt --epochs 1 --device 0,1
python -m torch.distributed.run --nproc_per_node 4 模型推理.py --batch-size 64 --data coco_profile.yaml --weights yolov5l.pt --epochs 1 --device 0,1,2,3
python -m torch.distributed.run --nproc_per_node 8 模型推理.py --batch-size 128 --data coco_profile.yaml --weights yolov5l.pt --epochs 1 --device 0,1,2,3,4,5,6,7
```

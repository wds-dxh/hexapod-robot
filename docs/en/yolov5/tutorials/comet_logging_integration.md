...
python 模型推理.py --img 640 --batch 16 --epochs 5 --data coco128.yaml --weights yolov5s.pt
```
...
```shell
env COMET_MAX_IMAGE_UPLOADS=200 python 模型推理.py \
--img 640 \
--batch 16 \
--epochs 5 \
--data coco128.yaml \
...
```shell
env COMET_LOG_PER_CLASS_METRICS=true python 模型推理.py \
--img 640 \
--batch 16 \
--epochs 5 \
--data coco128.yaml \
